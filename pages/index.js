...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Rasul Agasiyev Portofolio</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className="dark:bg-gray-900 bg-white px-10 text-black md:px-20 lg:px-40">
        <section className="min-h-screen fo">
          ...
          <div className="text-center p-10">
            ...
            <h3 className="dark:text-white text-3xl py-2 md:text-3xl">
              Developer and designer.
            </h3>
            <p className="dark:text-gray-200 text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto">
